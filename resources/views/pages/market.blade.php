  ...
  <div class="butt-content">
    <div class="container">
      ...
      <div class="floor-excerpt">
        ...
        <a href="#">{{ __('More Purchase') }} <i class="fa-solid fa-caret-right"></i></a>
      </div>
          ...
          <div class="swiper-slide">
            <div class="slide-row">
              <div class="slide-item">
                <a class="name" href="#">采购产品示例数据</a>
                <div class="box">
                  <div class="row date">
                    <div class="col-md-6 date-left">
                      <div class="date-title">发布日期</div>
                      <div class="date-data">2022-09-01</div>
                    </div>
                    <div class="col-md-6">
                      <div class="date-title">截止日期</div>
                      <div class="date-data">长期有效</div>
                    </div>
                  </div>
                  <div class="time">
                    ...
                    <div class="time-progress row">
                      ...
                      <div class="time-word col-md-4">长期有效</div>
                    </div>
                  </div>
                </div>
              </div>
